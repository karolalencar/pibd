...
public class Corrida {
    ...
    public Corrida(Integer id, String cpf, String chassi, LocalDate iniciaAs, LocalDate terminaAs, Double valor,
            String iniciaEm, String terminaEm, Long agendamentoId, Long faturaId) {
        this.setId(id);
        this.setCpf(cpf);
